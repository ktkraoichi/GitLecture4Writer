...
最後に Git と SourceTree のインストール手順も書きます。

### 1-2 Git のしくみ

まだ触らないでください。仕組みの概要を覚える方が先です。
...
リモートリポジトリとして使う GitHub の準備を書きます。 CUI がベストだが、初学者は GUI を導入してしまえ、ということも書きます。 GitHub にリポジトリを作って SourceTree を使ってリモートから `clone` するところまで済んだら完了です。
